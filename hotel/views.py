    ...
    if request.method == "POST":
        if "filter" in request.POST:
            if request.POST.get("type") != "":
                events = events.filter(eventType__contains=request.POST.get("type"))

            if request.POST.get("name") != "":
                events = events.filter(location__contains=request.POST.get("location"))
            ...
            return render(request, path + "manager/events.html", context)
...
def createEvent(request):
    ...
    return render(request, path + "manager/createEvent.html", context)
...
def deleteEvent(request, pk):
    ...
    return render(request, path + "manager/deleteEvent.html", context)
...
def event_profile(request, id):
    ...
    return render(request, path + "manager/event-profile.html", context)
...
def event_edit(request, pk):
    ...
    context = {"role": role, "event": event, "form": form1}
    ...
    return render(request, path + "manager/event-edit.html", context)
...
def announcements(request):
    ...
    context = {"role": role, 'announcements': announcements}
    ...
    if request.method == "POST":
        ...
        if "filter" in request.POST:
            ...
            if request.POST.get("date") != "":
                announcements = announcements.filter(date=request.POST.get("date"))
        ...
        return render(request, path + "manager/announcements.html", context)
...
def deleteAnnouncement(request, pk):
    ...
    context = {"role": role, 'announcement': announcement}
    return render(request, path + "manager/deleteAnnouncement.html", context)
...
def storage(request):
    ...
    context = {"role": role, 'storage': storage}
    if request.method == "POST":
        ...
        if "filter" in request.POST:
            if request.POST.get("id") != "":
                storage = storage.filter(id__contains=request.POST.get("id"))

            if request.POST.get("name") != "":
                storage = storage.filter(itemName__contains=request.POST.get("name"))

            if request.POST.get("type") != "":
                storage = storage.filter(itemType__contains=request.POST.get("type"))
        ...
        return render(request, path + "manager/storage.html", context)
...
def deleteStorage(request, pk):
    ...
    context = {"role": role, 'storage': storage}
    return render(request, path + "manager/deleteStorage.html", context)
...
def food_menu(request):
    ...
    context = {"role": role, 'food_menu': food_menu}
    return render(request, path + "staff/food-menu.html", context)
...
def deleteFoodMenu(request, pk):
    ...
    context = {"role": role, 'food_menu': food_menu}
    return render(request, path + "manager/deleteFoodMenu.html", context)
...
def food_menu_edit(request, pk):
    ...
    context = {"role": role, 'food_menu': food_menu}
    return render(request, path + "staff/food-menu-edit.html", context)
...
def error(request):
    ...
    context = {"role": role}
    return render(request, path + "admin/error.html", context)
...
def payment(request):
    ...
    def send(request, receiver, code):
        ...
        # do something ???
        return render(request, path + "guest/verify.html", context)
    ...
    return render(request, path + "guest/payment.html", context)
