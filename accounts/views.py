    ...
    if request.user.is_authenticated:
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                curGuest = Guest(user=user, phoneNumber=request.POST.get("phoneNumber"))
                curGuest.save()
...
def add_employee(request):
    ...
    context = {'form': form, 'form2': form2, 'form3': form3, "role": role}
    return render(request, path + "admin/add-employee.html", context)
    ...
    if request.method == "POST":
        ...
        if "filterGuest" in request.POST:
            ...
            if request.POST.get("number") != "":
                guests = guests.filter(phoneNumber__contains=request.POST.get("number"))
            ...
            return render(request, path + "admin/guests.html", context)
...
def employees(request):
    ...
    if request.method == "POST":
        ...
        return render(request, path + "admin/employees.html", context)
...
def employee_details(request, pk):
    ...
    return render(request, path + "admin/employee-profile.html", context)
...
def employee_details_edit(request, pk):
    ...
    return render(request, path + "admin/employee-edit.html", context)
...
def guest_edit(request, pk):
    ...
    return render(request, path + "admin/guest-edit.html", context)
...
def guest_profile(request, pk):
    ...
    return render(request, path + "admin/guest-profile.html", context)
...
def tasks(request):
    ...
    if request.method == "POST":
        ...
        if "filter" in request.POST:
            ...
            if request.POST.get("desc") != "":
                tasks = tasks.filter(description__contains=request.POST.get("desc"))
    ...
    return render(request, path + "staff/tasks.html", context)
